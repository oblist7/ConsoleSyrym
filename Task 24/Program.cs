 ...
 * Generic Classes
 * 
 * The class Elems creates a 3-sized array of integers, defines Add() and Show() methods
 * to store the elements into the array, and shows them separated by a space.
